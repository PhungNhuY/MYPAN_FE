...
const schema = Yup.object().shape({
    name: Yup.string().required('Trường này không được để trống').max(1000),
    ingre: Yup.string().required('Trường này không được để trống'),
    step: Yup.string().required('Trường này không được để trống'),
});
</script>
            ...
            <MyCard class="base-info">
                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <Field name="name" type="text" class="base-input form-control" :class="{ 'is-invalid': errors.name }" v-model="name"/>
            ...
            <MyCard class="ingre">
                ...
                <div v-for="(ingre, index) in ingres" :key="index" class="row mb-2">
                    <div class="col-6">
                        ...
                        <Field name="ingre" type="text" class="base-input form-control" :class="{ 'is-invalid': errors.ingre }" v-model="ingre.name"/>
                        <div class="invalid-feedback">{{ errors.ingre }}</div>
                    </div>
                    <div class="col-5">

            ...
            <MyCard class="base-info">
                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <Field name="ration" type="number" class="base-input form-control" :class="{ 'is-invalid': errors.ration }" v-model="ration"/>
                            ...
                            <div class="col-6">
                                ...
                                <Field name="time" type="number" class="base-input form-control" :class="{ 'is-invalid': errors.time }" v-model="time"/>
                    ...
                    <div class="col-6">
                        ...
                        <Field name="des" as="textarea" class="base-textarea description-content" :class="{ 'is-invalid': errors.des }" rows="3" v-model="des"/>
